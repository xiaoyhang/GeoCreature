...
const creatureProfiles = {
    Singleton: {
        ...
        core: "孤立点 / 离散拓扑",
        space: "平凡的度量空间",
        persona: "你是空间中的一个单点，极其独立，世界对你而言是由无数闪耀的瞬间组成的。你不依附于连续的群体，在孤寂中拥有最清醒的引力场。",
        concept: "离散拓扑",
    ...
    FilledTorus: {
        ...
        concept: "单连通性",
        desc: "琥珀藏心者内部有一个‘洞’或嵌套核，使得某些情感路径永远无法被外界抹平，象征着独特的心理界限与深度。"
    },
    Manhattan: {
    ...
    Mobius: {
        ...
        core: "单侧曲面 / 紧致流形",
        space: "不可定向流形",
        persona: "你仿佛莫比乌斯带，是一个纯粹且一致的整体，自洽而真诚。在你的字典里没有‘正反面’，你的起始亦是终点，内外在达成了奇妙的统一。",
        concept: "莫比乌斯带",
        desc: "这是一个只有一个面和一个边界的曲面。它代表了打破二元对立的思维方式，象征着一种极其稳定的逻辑闭环。"
    },
    LightCone: {
        ...
        core: "光锥结构的时空流形",
        space: "闵可夫斯基时空",
        persona: "你看重时机与因果。你总能从错综复杂的线索中，精准预判哪些事会成为改变命运的‘奇点’。",
        concept: "闵可夫斯基空间",
...
const questions = [
    {
        ...
        options: [
            ...
            { text: "一条平滑、无限延伸的丝绸一样的路", impact: { c: 0.2, s: 0.1 } },
    ...
    },
    {
        text: "你选择的行进方式是？",
        options: [
            { text: "既然目标在前方，我就要径直地穿过去", impact: { m: -0.2, s: 0.1 } },
            { text: "我喜欢像在城市街区那样规整地转弯，正南正北前进", impact: { m: -0.1, s: -0.1 } },
    ...
    },
    {
        ...
        options: [
            ...
            { text: "是一段可以被连续测量的跨度", impact: { c: 0.2, m: -0.2 } },
            { text: "这取决于我们看对方的方式", impact: { m: 0.3 } }
        ]
    },
    {
        text: "你摸到了一株“几何仙人掌”，它表面布满了极其细密的突起：",
        options: [
            { text: "虽然看起来复杂，但刺群的触感却具有某种重复性的规律", impact: { s: -0.2, m: 0.1 } },
            { text: "你的指尖感受到一种酥麻的触感，那是生命力的震荡", impact: { s: -0.3, c: -0.1 } },
            { text: "比起刺球，你更希望它是一个光滑的果冻球，触碰起来毫无阻力", impact: { s: 0.3 } }
        ]
    },
    {
        ...
        options: [
            ...
            { text: "开始在脑海中构思全新的备选方案，让旅行能够继续", impact: { s: -0.1, c: 0.1 } },
            { text: "觉得这场雨是某种命运的转折点，试图观察它带来的因果变化", impact: { m: 0.2, h: -0.1 } }
        ]
    },
    {
        text: "你发现了一面镜子，但无法照见自己的背面。你觉得：",
        options: [
            { text: "说明我是一个纯粹且一致的整体", impact: { m: 0.2, h: 0.2 } },
            { text: "我试图寻找镜子的边界，看看到底在哪里发生扭转", impact: { m: 0.2 } },
            { text: "这显然不太可能", impact: { m: -0.2 } }
        ]
    },
    {
        text: "你觉得你的内心世界更像：",
    ...
    },
    {
        ...
        options: [
            { text: "一束直击靶心的激光，寻找关键", impact: { s: 0.2, c: 0.1 } },
    ...
    },
    {
        text: "你抬头看星空，觉得时间是：",
        options: [
            { text: "滴漏均匀滴落的水滴", impact: { m: -0.2 } },
            { text: "随着你的奔跑而伸缩的道路", impact: { m: 0.3, c: 0.1 } },
    ...
    },
    {
        ...
        options: [
            { text: "让重力消失，万物皆可漂浮", impact: { m: 0.2, s: -0.1 } },
            { text: "让光速变慢，我们可以看清时间的流逝", impact: { m: 0.3, h: 0.1 } },
            { text: "让所有物体都变成圆滚滚的样子", impact: { s: 0.3, m: -0.2 } }
        ]
    }
];
...
function showResult() {
    ...
    let curvatureDesc = "";
    if (curvature > 0) {
        curvatureDesc = "：你的灵魂是温暖的闭合球体";
    } else if (curvature < 0) {
        curvatureDesc = "：你的灵魂是自由开敞的马鞍面";
    } else {
        curvatureDesc = "：你的灵魂是绝对平直的平面";
    }
